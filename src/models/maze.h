...
class Maze {
 public:
  ...
  bool IsIdeal();
  std::vector<int> FindPath(std::pair<size_t, size_t>, std::pair<size_t, size_t>);
  std::vector<std::pair<size_t, size_t>> FindSolution(std::pair<size_t, size_t>, std::pair<size_t, size_t>, std::vector<int>);
